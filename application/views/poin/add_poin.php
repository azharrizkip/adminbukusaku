          ...
          <section class="col-lg-12">
            ...
            <div class="box">
              <div class="box-header">
                ...
                <h3 class="box-title">FORM TAMBAH POIN</h3>
              </div>
              <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>poin/savedata" method="POST" enctype="multipart/form-data">
                  <div class="col-lg-12">
                   ...
                   <div class="form-group">
                    <label for="">BARANG</label>
                      <input type="text" class="form-control" value="" id="" name="barang" placeholder="" required>
                  </div>
                  </div>
