          ...
          <section class="col-lg-12">
            ...
            <div class="box">
              ...
              <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>rangking/updaterangking" method="POST" enctype="multipart/form-data">
                  <div class="col-lg-6">
                    ...
                    <div class="form-group">
                      <label for="">KELAS</label>
                        <input type="text" class="form-control" value="<?php echo $kelas; ?>" id="" name="kelas" placeholder="" >                        
                    </div>    
                     <div class="form-group">
                      <label for="">POIN</label>
                        <input type="text" class="form-control" value="<?php echo $tpoin; ?>" id="" name="poin" placeholder="" >                        
                    </div> 
                    </div>
                    <div class="col-lg-6">
                    <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <a href="<?php echo base_url(); ?>rangking" class="btn btn-warning btn-block btn-flat">Kembali</a>
                </div><!-- /.col -->
               </form>
