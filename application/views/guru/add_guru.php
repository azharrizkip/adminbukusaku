                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="form-group">
                      <label for="">Mapel 01</label>
                        <input type="text" class="form-control" value="" id="" name="mapel1" placeholder="" required>
                    </div>
                    <div class="form-group">
                      <label for="">Mapel 02</label>
                        <input type="text" class="form-control" value="" id="" name="mapel2" placeholder="">
                    </div>
                    <div class="form-group">
                      <label for="">Mapel 03</label>
                        <input type="text" class="form-control" value="" id="" name="mapel3" placeholder="">
                    </div>
                  </div>
                </div><!-- /.item -->
                <div class="form-group">
