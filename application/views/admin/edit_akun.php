          ...
          <section class="col-lg-12">
            ...
            <div class="box">
              ...
              <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>admin/kirim" onsubmit="return validasi_input(this)" id="form-login" method="POST" enctype="multipart/form-data">
                  <div class="col-lg-6">
                    ...
                    <div class="form-group">
                      <label for="">Email</label>
                        <input type="text" class="form-control" value="<?php echo $email; ?>" id="" name="email" placeholder="" required>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="">Sandi Baru</label>
                        <input type="password" class="form-control"  id="" name="password1" placeholder="" >
                    </div>
                    <div class="form-group">
                      <label for="">Konfirmasi Sandi</label>
                        <input type="password" class="form-control"  id="" name="password2" placeholder="" >
                    </div>
                    </div>
                  </div><!-- /.item -->
                <div class="form-group">
